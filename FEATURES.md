...
| HUB | Lesson | Status | PRD | Unit | Notes |
|-----|--------|--------|-----|------|-------|
| HUB-10 | System Architecture | ✅ | §4 | U1 | Next.js App Router, Supabase Postgres, NextAuth v5, next-intl, Vercel |
| HUB-11 | Database Design | ✅ | §4.3, §5 | U2 | 21 Prisma models, 11 enums, audit logs, FTS tsvector, migrations |
| HUB-12 | Development Standards | 🟦 | - | - | ESLint 9, TypeScript strict, Prettier, pre-commit hooks |
| HUB-13 | Technology Stack | ✅ | §4 | U1 | Next.js 16, Prisma ORM, Supabase, NextAuth v5, next-intl, Zod, Vitest |
| HUB-14 | Project Structure | ✅ | §4 | U1 | `src/app/`, `src/lib/`, `src/components/`, `prisma/`, `.claude/` layout |
| HUB-15 | Coding Standards | 🟦 | - | - | Variable naming, function conventions, error handling, patterns |
| HUB-16 | Architecture Decisions (ADRs) | ✅ | KD1-KD6 | - | USD base pricing, WhatsApp Cloud API, EN+SO, scope decisions |
| HUB-17 | API Standards | 🟦 | §4.2 | - | HTTP status codes, auth headers, validation, error responses |
| HUB-18 | Database Schema Reference | ✅ | §4.3 | U2 | `prisma/schema.prisma` as source of truth; generated docs |
| HUB-19 | Coding Guidelines | 🟦 | - | - | Type safety, null handling, async patterns, testing strategy |
...
| HUB | Lesson | Status | PRD | Unit | Notes |
|-----|--------|--------|-----|------|-------|
| HUB-20 | UI Design System | 🟦 | R30 | HUR-37 | Colors, typography, spacing, component patterns |
| HUB-21 | Accessibility | 🟦 | R30 | HUR-96 | WCAG 2.1 AA: keyboard nav, screen readers, color contrast, alt text |
