...
const CATEGORIES: SeedCategory[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        priceUsd: "229.00",
        stock: 40,
        descriptionEn: "Large 120Hz AMOLED screen and 33W fast charging at an entry-level price.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "199.00",
        stock: 35,
        descriptionEn: "Dual-SIM handset tuned for African networks, with a 50MP selfie camera.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "249.00",
        stock: 28,
        descriptionEn: "45W wired and 20W wireless charging with a 108MP stabilised camera.",
        descriptionSo:
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        priceUsd: "799.00",
        stock: 18,
        descriptionEn: "Ryzen 5 performance, legendary ThinkPad keyboard and a fingerprint reader.",
        descriptionSo: "Awood Ryzen 5, kiiboodhka caanka ah ee ThinkPad iyo akhriste farageliska.",
      },
      {
        ...
        priceUsd: "1099.00",
        stock: 7,
        descriptionEn: "Fanless M3 chip, 18-hour battery and a 13.6-inch Liquid Retina display.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "499.00",
        stock: 22,
        descriptionEn: "Affordable everyday laptop for study and office work, with a 512GB SSD.",
        descriptionSo:
    ...
    products: [
      {
        ...
        priceUsd: "399.00",
        stock: 14,
        descriptionEn: "10.9-inch Liquid Retina display with the A14 Bionic chip and USB-C.",
        descriptionSo: "Shaashad Liquid Retina 10.9 inji ah, chip A14 Bionic ah iyo USB-C.",
      },
      {
        ...
        priceUsd: "449.00",
        stock: 11,
        descriptionEn: "Water-resistant tablet that ships with the S Pen included.",
        descriptionSo: "Tablet biyo iska celiya oo la yimaada qalinka S Pen.",
      },
      {
        ...
        priceUsd: "229.00",
        stock: 26,
        descriptionEn: "11-inch 90Hz screen with quad speakers, built for family media use.",
        descriptionSo: "Shaashad 11 inji ah oo 90Hz ah, afar sameecadood, oo qoyska ku habboon.",
      },
      {
        ...
        priceUsd: "349.00",
        stock: 16,
        descriptionEn: "Snapdragon 870 with a 144Hz display for gaming and video.",
        descriptionSo: "Snapdragon 870 leh shaashad 144Hz ah oo ciyaaraha iyo muuqaalka ku fiican.",
      },
      {
        ...
        priceUsd: "149.00",
        stock: 30,
        descriptionEn: "Budget 10-inch tablet for reading, streaming and light browsing.",
        descriptionSo: "Tablet 10 inji ah oo qiimo jaban, akhris, daawasho iyo raadin fudud.",
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        priceUsd: "59.00",
        stock: 60,
        descriptionEn: "Charges a phone four times over, with 20W USB-C power delivery.",
        descriptionSo: "Afar jeer ayuu taleefan dallici karaa, leh 20W USB-C.",
      },
      {
        ...
        priceUsd: "99.00",
        stock: 32,
        descriptionEn: "Near-silent clicks, 8K DPI tracking and multi-device switching.",
        descriptionSo: "Riix aad u aamusan, tracking 8K DPI ah iyo u beddelasho qalab badan.",
      },
      {
        ...
        priceUsd: "129.00",
        stock: 25,
        descriptionEn: "Adaptive noise cancelling with up to 70 hours of playback.",
        descriptionSo: "Buuq joojin isbeddelaysa iyo ilaa 70 saacadood oo dhageysi ah.",
      },
      {
        ...
        priceUsd: "49.00",
        stock: 45,
        descriptionEn: "Four ports and enough power to charge a laptop and two phones at once.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "19.00",
        stock: 80,
        descriptionEn: "A1-rated card with 140MB/s reads for phones, cameras and dash cams.",
        descriptionSo: "Kaar A1 ah oo 140MB/s akhrinaya, taleefanno, kaamirooyin iyo dash cam.",
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        priceUsd: "99.00",
        stock: 30,
        descriptionEn: "AX3000 dual-band router covering a medium home or small office.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "109.00",
        stock: 20,
        descriptionEn: "Ceiling-mounted Wi-Fi 6 access point with PoE and central management.",
        descriptionSo: "Barta gelitaanka Wi-Fi 6 saqafka lagu dhejiyo, leh PoE iyo maamul dhexe.",
      },
      {
        ...
        priceUsd: "69.00",
        stock: 24,
        descriptionEn: "Five-port gigabit router running RouterOS, popular with local ISPs.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "29.00",
        stock: 50,
        descriptionEn: "Unmanaged metal-cased switch for expanding a wired office network.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "139.00",
        stock: 18,
        descriptionEn: "UV-resistant solid copper cable for outdoor runs between buildings.",
        descriptionSo:
    ...
    products: [
      {
        ...
        priceUsd: "89.00",
        stock: 40,
        descriptionEn: "Full-colour night imaging with a built-in microphone and IP67 rating.",
        descriptionSo: "Sawir habeen oo midab buuxa leh, maykarafoon ku dhex jira iyo heer IP67.",
      },
      {
        ...
        priceUsd: "279.00",
        stock: 12,
        descriptionEn: "Eight PoE ports, 4K recording and a pre-installed 2TB surveillance drive.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "499.00",
        stock: 10,
        descriptionEn: "Complete shop kit: four 4MP cameras, NVR, cabling and connectors.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "39.00",
        stock: 55,
        descriptionEn: "360-degree Wi-Fi camera with motion tracking and two-way audio.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "119.00",
        stock: 20,
        descriptionEn: "Drive rated for 24/7 video writing, tuned for multi-camera NVRs.",
        descriptionSo: "Disk loogu talagalay duubis 24/7 ah, oo NVR kaamiro badan leh ku habboon.",
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        priceUsd: "319.00",
        stock: 14,
        descriptionEn: "Mono laser printer, 38 pages per minute with automatic duplexing.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "429.00",
        stock: 8,
        descriptionEn: "Office multifunction laser with a 50-sheet document feeder and fax.",
        descriptionSo: "Laser xafiis oo shaqooyin badan leh, quusiye 50 warqadood iyo faakis.",
      },
      {
        ...
        priceUsd: "259.00",
        stock: 16,
        descriptionEn: "High-yield colour ink tank printer with duplex printing and Wi-Fi.",
        descriptionSo:
      ...
      },
      {
        ...
        priceUsd: "49.00",
        stock: 42,
        descriptionEn: "58mm USB thermal printer for shop receipts; no ink cartridges needed.",
        descriptionSo:
    ...
    products: [
      {
        ...
        priceUsd: "59.00",
        stock: 48,
        descriptionEn: "Desktop memory module with an aluminium heat spreader and XMP profiles.",
        descriptionSo: "Xusuusta desktop leh faafiye kulayl aluminium ah iyo astaamo XMP.",
      },
      {
      ...
      },
      {
        ...
        priceUsd: "139.00",
        stock: 19,
        descriptionEn: "Six cores and twelve threads on socket AM4, cooler included.",
        descriptionSo: "Lix xudun iyo laba iyo toban dun oo socket AM4 ah, qaboojiye la socda.",
      },
      {
        ...
        priceUsd: "109.00",
        stock: 17,
        descriptionEn: "Micro-ATX AM4 board with PCIe 4.0, dual M.2 slots and USB 3.2.",
        descriptionSo: "Loox Micro-ATX AM4 ah oo leh PCIe 4.0, laba god M.2 iyo USB 3.2.",
      },
      {
