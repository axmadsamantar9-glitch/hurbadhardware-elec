...
- Explicit secret env var scrubbing (DATABASE_URL, DIRECT_URL, WAAFIPAY_*, EDAHAB_*, etc.)
...
**Dogfood:**
8. `scripts/dogfood-u4.ts` — E2E entrypoint exercising 4 critical user flows
