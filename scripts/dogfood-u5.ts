...
async function testFlow(name: string, path: string, validate: (body: unknown) => boolean, isDatabaseUnavailable: boolean): Promise<void> {
  try {
    log(`Testing: ${name}`)
    ...
    if (isDatabaseUnavailable && status === 500) {
      if (typeof body === 'object' && body !== null) {
        ...
        if (obj.error && typeof obj.error === 'object' && (obj.error as Record<string, unknown>).code === 'internal_error') {
...
async function main() {
  ...
  try {
    ...
    await testFlow('List all products (no filter)', '/api/products', (body) => {
    ...
    await testFlow('Search products', '/api/products?search=Samsung', (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.products !== undefined && obj.total !== undefined
    }, !dbAvailable)

    await testFlow('Filter by category', '/api/products?category=smartphones', (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.products !== undefined && obj.total !== undefined
    }, !dbAvailable)

    await testFlow('Filter by brand', '/api/products?brand=Apple', (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.products !== undefined && obj.total !== undefined
    }, !dbAvailable)

    await testFlow('Filter by price range', '/api/products?priceMin=100&priceMax=500', (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.products !== undefined && obj.total !== undefined
    }, !dbAvailable)

    await testFlow('Combine search + category', '/api/products?search=phone&category=smartphones', (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.products !== undefined && obj.total !== undefined
    }, !dbAvailable)

    await testFlow('Pagination - page 1', '/api/products?page=1&limit=10', (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.page === 1 && obj.limit === 10 && obj.hasMore !== undefined
    }, !dbAvailable)

    await testFlow('Pagination - page 2', '/api/products?page=2&limit=10', (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.page === 2 && obj.limit === 10
    }, !dbAvailable)

    await testFlow('SQL injection protection - category', "/api/products?category=test' OR '1'='1", (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.total !== undefined
    }, !dbAvailable)

    await testFlow('SQL injection protection - brand', "/api/products?brand='; DROP TABLE; --", (body) => {
      if (typeof body !== 'object' || body === null) return false
      const obj = body as Record<string, unknown>
      return obj.total !== undefined
    }, !dbAvailable)
